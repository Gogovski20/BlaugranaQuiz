...
CREATE DATABASE blaugrana\_quiz\_db;
...
DB\_URL=jdbc:postgresql://localhost:5432/blaugrana\_quiz\_db
...
spring.datasource.url=${DB\_URL:jdbc:postgresql://localhost:5432/blaugrana\_quiz\_db}

spring.datasource.username=${DB\_USERNAME:postgres}

spring.datasource.password=${DB\_PASSWORD:postgres}
...
VITE\_API\_BASE\_URL=http://127.0.0.1:8080/api
